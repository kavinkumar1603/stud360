...
export const AddStudentModal: React.FC<AddStudentModalProps> = ({ isOpen, onClose, onAdd, classId }) => {
  const [formData, setFormData] = useState({
    ...
    section: 'A',
    year: '2026-2027',
    semester: 'Semester 1' as Semester,
    class_id: classId || ''
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onAdd({
      ...formData,
      class_id: classId || formData.class_id
    });
    onClose();
  };
